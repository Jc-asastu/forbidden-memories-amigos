...
document.addEventListener('keydown',e=>{
 ...
 if(e.key==='Escape'&&!dialog){e.preventDefault();if(state.game.running||state.network.room&&state.network.room.state!=='waiting'){notice('Escape no cierra una partida en curso.');return;}$('arena-exit').click();return;}
